...
export const API_CONFIG = {
  ...
  BASE_URL: process.env.NEXT_PUBLIC_API_URL || 'https://innovative-merit-bailey-ambient.trycloudflare.com',
  
  // Fallback URLs if primary fails
  FALLBACK_URLS: [
    'https://ocean-lake-claims-transcription.trycloudflare.com',
    'https://innovative-merit-bailey-ambient.trycloudflare.com'
  ],
